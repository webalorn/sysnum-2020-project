...
# %bb.0:
	...
	mv	s5, sp
	lui	a0, %hi(.L.str.16)
	addi	s11, a0, %lo(.L.str.16)
	addi	s6, zero, 12
	addi	s7, zero, 200
	lui	s8, %hi(nbBlocks)
	lui	s9, %hi(_ZL4cout)
	addi	s10, s9, %lo(_ZL4cout)
	j	.LBB39_3
...
.LBB39_3:                               # =>This Loop Header: Depth=1
	...
	addi	s0, zero, 1
	j	.LBB39_5
.LBB39_4:                               #   in Loop: Header=BB39_5 Depth=2
	lw	s1, 8(sp)
	slli	a0, a0, 2
	add	a0, s1, a0
	sw	s4, 0(a0)
...
# %bb.12:                               #   in Loop: Header=BB39_3 Depth=1
	lw	a0, %lo(nbBlocks)(s8)
	beqz	a0, .LBB39_1
# %bb.13:                               #   in Loop: Header=BB39_3 Depth=1
	lw	a1, %lo(allocPos)(s3)
	mv	a2, zero
